...
class KubernetesDriver(ResourceDriverInterface):
    ...
    def get_inventory(self, context):
        ...
        with LoggingSessionContext(context) as logger, ErrorHandlingContext(logger):
            ...
            self.autoload_operation.validate_cloud_provider_resource_config(cloud_provider_resource)
    ...
    # <editor-fold desc="Custom commands">

    def GetAutoloadData(self, context, ports):
        """
        Returns a json string with data for the deployed app autoload to create container sub resources
        :param context:
        :param ports:
        :return:
        """
        with LoggingSessionContext(context) as logger, ErrorHandlingContext(logger):
            ...
            clients = self.api_clients_provider.get_api_clients(cloud_provider_resource)
            deployed_app = DeployedAppResource(context.remote_endpoints[0])
            return self.autoload_operation.get_deployed_app_autoload_data(clients, deployed_app)
