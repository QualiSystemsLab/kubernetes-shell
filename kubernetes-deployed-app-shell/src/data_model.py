...
class KubernetesDeployedApp(object):
    def __init__(self, name):
        ...
        self.attributes = {}
        self.resources = {}
        self._cloudshell_model_name = 'KubernetesDeployedApp'
        self._name = name
    ...
    def create_from_context(cls, context):
        ...
        :return:
        :rtype KubernetesDeployedApp
        """
        result = KubernetesDeployedApp(name=context.resource.name)
    ...
    def user(self):
        ...
        :rtype: str
        """
        return self.attributes['KubernetesDeployedApp.User'] if 'KubernetesDeployedApp.User' in self.attributes else None
    ...
    def user(self, value):
        ...
        :type value: str
        """
        self.attributes['KubernetesDeployedApp.User'] = value
    ...
    def password(self):
        ...
        :rtype: string
        """
        return self.attributes['KubernetesDeployedApp.Password'] if 'KubernetesDeployedApp.Password' in self.attributes else None
    ...
    def password(self, value):
        ...
        :type value: string
        """
        self.attributes['KubernetesDeployedApp.Password'] = value
    ...
    def public_ip(self):
        ...
        :rtype: str
        """
        return self.attributes['KubernetesDeployedApp.Public IP'] if 'KubernetesDeployedApp.Public IP' in self.attributes else None
    ...
    def public_ip(self, value):
        ...
        :type value: str
        """
        self.attributes['KubernetesDeployedApp.Public IP'] = value
...
class Container(object):
    def __init__(self, name):
        ...
        self.attributes = {}
        self.resources = {}
        self._cloudshell_model_name = 'KubernetesDeployedApp.Container'
        self._name = name
    ...
    def create_from_context(cls, context):
        ...
        :rtype Container
        """
        result = Container(name=context.resource.name)
        for attr in context.resource.attributes:
            result.attributes[attr] = context.resource.attributes[attr]
        return result
    ...
    def user(self):
        ...
        :rtype: str
        """
        return self.attributes['KubernetesDeployedApp.Container.User'] if 'KubernetesDeployedApp.Container.User' in self.attributes else None
    ...
    def user(self, value):
        ...
        :type value: str
        """
        self.attributes['KubernetesDeployedApp.Container.User'] = value
    ...
    def password(self):
        ...
        :rtype: string
        """
        return self.attributes['KubernetesDeployedApp.Container.Password'] if 'KubernetesDeployedApp.Container.Password' in self.attributes else None
    ...
    def password(self, value):
        ...
        :type value: string
        """
        self.attributes['KubernetesDeployedApp.Container.Password'] = value
    ...
    def ip_address(self):
        ...
        :rtype: str
        """
        return self.attributes['KubernetesDeployedApp.Container.IP Address'] if 'KubernetesDeployedApp.Container.IP Address' in self.attributes else None
    ...
    def ip_address(self, value):
        ...
        :type value: str
        """
        self.attributes['KubernetesDeployedApp.Container.IP Address'] = value
    ...
    def model_name(self):
        ...
        :rtype: str
        """
        return self.attributes['CS_Container.Model Name'] if 'CS_Container.Model Name' in self.attributes else None
    ...
    def model_name(self, value):
        ...
        :type value: str
        """
        self.attributes['CS_Container.Model Name'] = value
